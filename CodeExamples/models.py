...
The binary lens model has a planetary mass ratio and
one can clearly see that the planetary anomaly is a short perturbation
on top of smooth single point lens light curve. 

Also the lens source
...
# Create a planet model with PSPL parameters
s = 1.5
q = 0.001
alpha = 159.0
rho = 0.001
...
# Que papel juega el flex blending?
""" plt.figure()
